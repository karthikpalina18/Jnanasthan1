...
// Configure CORS with more restrictive options - FIXED: Removed trailing slash
...
// Initialize Socket.io server with authentication - FIXED: Updated CORS config
const io = new Server(server, {
  cors: {
    origin: allowedOrigins,
    methods: ["GET", "POST"],
    credentials: true,
    allowEIO3: true // Add backward compatibility if needed
  },
