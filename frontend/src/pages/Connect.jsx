...
const Connect = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const [connectionsResponse, requestsResponse] = await Promise.all([
          axios.get('https://jnanasthan1-production.up.railway.app/connection/myConnections', config),
          axios.get('https://jnanasthan1-production.up.railway.app/connection/pendingRequests', config)
        ]);
  ...
  const acceptRequest = async (connectionId) => {
    try {
      ...
      await axios.put(`https://jnanasthan1-production.up.railway.app/connection/${connectionId}/accept`, {}, config);
