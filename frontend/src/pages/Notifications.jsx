...
const Notifications = () => {
  ...
  const getNotifications = async () => {
    ...
    try {
      ...
      const response = await axios.get('https://jnanasthan1-production.up.railway.app/notification', {
        headers: {
  ...
  const markAsRead = async (notificationId) => {
    try {
      ...
      await axios.put(`https://jnanasthan1-production.up.railway.app/notification/${notificationId}/read`, {}, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      });
