  ...
  useEffect(() => {
    const fetchQuiz = async () => {
      try {
        ...
        const res = await axios.get(`https://jnanasthan1-production.up.railway.app/quiz/${id}`, {
          headers: {
            'x-auth-token': token
          }
        });
        ...
        const attemptRes = await axios.post(
          `https://jnanasthan1-production.up.railway.app/attempt/start`,
          { 
            quizId: id,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        `https://jnanasthan1-production.up.railway.app/attempt/submit`,
        requestData,
        {
          headers: {
            'x-auth-token': token,
